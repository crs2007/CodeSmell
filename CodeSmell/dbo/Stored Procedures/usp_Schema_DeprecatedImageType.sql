...
-- Description:	Finding a image|text|ntext type column.
-- =============================================
CREATE PROCEDURE [dbo].[usp_Schema_DeprecatedImageType]
...
BEGIN
	...
	WHERE	C.system_type_id IN (34,35,99) -- image|text|ntext
			AND t.name != ''sysarticles''
